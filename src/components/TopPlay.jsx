...
const TopChartCard = ({
  ...
  <div className="w-full flex flex-row items-center hover:bg-gradient-to-br hover:from-white/10 hover:to-[#181725] hover:backdrop-blur-lg py-2 p-4 rounded-lg cursor-pointer mb-2 text-white">
    ...
    <div className="flex-1 flex flex-row justify-between item-center">
      ...
      <div className="flex flex-1 flex-col justify-center mx-3">
        ...
        <Link to={`/artists/${song?.artists[0].adamid}`}>
          <p className="text-base text-gray-300 mr-1"> {song?.subtitle}</p>
        </Link>
      </div>
    </div>
    <PlayPause
